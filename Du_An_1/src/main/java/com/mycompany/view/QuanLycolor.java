 ...
 */
public class QuanLycolor extends javax.swing.JDialog {

    /**
     * Creates new form Color
     */
    public QuanLycolor(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(QuanLycolor.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                QuanLycolor dialog = new QuanLycolor(new javax.swing.JFrame(), true);

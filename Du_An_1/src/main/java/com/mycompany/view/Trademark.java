 ...
 */
public class Trademark extends javax.swing.JDialog {

    /**
     * Creates new form Color
     */
    public Trademark(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Trademark.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                Trademark dialog = new Trademark(new javax.swing.JFrame(), true);

 ...
 */
public class QuanLysole extends javax.swing.JDialog {

    /**
     * Creates new form Color
     */
    public QuanLysole(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(QuanLysole.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                QuanLysole dialog = new QuanLysole(new javax.swing.JFrame(), true);
